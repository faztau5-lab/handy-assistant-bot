...
export const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background to-secondary/30"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            className="text-xl md:text-2xl mb-4 text-muted-foreground animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            Custom-made furniture for Dubai interiors
          </p>
          <p
            className="text-lg md:text-xl mb-8 text-primary font-semibold animate-fade-in"
